...
public class UserWorkAreaPanel extends javax.swing.JPanel {
    ...
    public UserWorkAreaPanel(UserInfo userData, HospitalInfo hosData, pharmacyInfo pharmData, SupplierInfo suppData) {
    ...
    private void lblUserCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblUserCreateMouseClicked
        ...
        CreateUserAdminPanel acu = new CreateUserAdminPanel(userData);
    ...
    private void UserViewlblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserViewlblMouseClicked
        // TODO add your handling code here:
        UserUpdatePanel uc = new UserUpdatePanel(userData);
