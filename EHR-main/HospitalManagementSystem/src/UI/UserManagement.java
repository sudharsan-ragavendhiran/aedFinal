...
public class UserManagement extends javax.swing.JPanel {
    ...
    public UserManagement(UserData userData, HospitalData hosData, pharmacyData pharmData, SupplierData suppData) {
    ...
    private void lblUserCreateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblUserCreateMouseClicked
        ...
        AdminCreateUser acu = new AdminCreateUser(userData);
    ...
    private void UserViewlblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserViewlblMouseClicked
        // TODO add your handling code here:
        UserCRUD uc = new UserCRUD(userData);
